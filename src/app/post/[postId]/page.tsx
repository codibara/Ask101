    ...
    <main className="min-h-svh px-5 py-5 md:px-26 mb-[72px] md:mb-0">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-row justify-center gap-4 mb-5">
          <div
            className={`flex flex-col justify-center items-center w-full max-w-[290px] p-5 bg-main rounded-[10px] ${
              selectedOption === "A"
          ...
          <div
            className={`flex flex-col justify-center items-center w-full max-w-[290px] p-5 rounded-[10px] border bg-main-shade ${
              selectedOption === "B"
                ? "border-2 border-gray-400"
                : "border-2 border-main-shade"
            }`}
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Comment Input (Fixed to bottom) - Only show for logged in users */}
          {isLoggedIn && !isAnyReplyOpen && (
          ...
          {/* Comment Input Desktop - Only show for logged in users */}
          {isLoggedIn && (
          ...
          {!isLoggedIn && (
            <div className="w-full p-4 bg-dark-900 rounded-md text-center">
