...
export default function Navigation() {
  ...
  const navItems = [
    ...
    <div className='flex md:inline-flex flex-row md:flex-col sticky bottom-0 left-0 md:h-svh md:justify-center'>
      <LogoDesktop />
      <ul className='flex flex-row md:flex-col justify-center w-full gap-4 md:gap-8 px-11 py-3 pb-7 md:py-11 md:px-5 bg-background/70 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none'>
